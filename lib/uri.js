 ...
 * ratoshis. Any other non-standard parameters can be found under the extra member.
 *
 * @example
 * ```javascript
 *
...
/**
 * Internal function to transform a BLK string amount into ratoshis
 *
 * @param {string} amount - Amount BLK string
 * @throws {TypeError} Invalid amount
 * @returns {Object} Amount represented in ratoshis
 */
URI.prototype._parseAmount = function(amount) {
  ...
  return Unit.fromBLK(amount).toRatoshis();
};
...
URI.prototype.toString = function() {
  var query = {};
  if (this.amount) {
    query.amount = Unit.fromRatoshis(this.amount).toBLK();
  }
  if (this.message) {
